...
export default function Footer() {
  return (
    <footer className="w-full bg-brand-card border-t border-brand-border py-12 px-8 md:px-16 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start gap-2">
          <Link to="/" className="text-2xl font-extrabold tracking-tighter text-brand-dark cursor-pointer select-none">
            GYM TRACKER
          </Link>
          <p className="text-sm font-medium text-brand-gray text-center md:text-left">
            Effort over ego. Progress over perfection.
          </p>
        </div>
        
        <nav className="flex flex-wrap items-center justify-center gap-6 text-sm font-bold text-brand-dark">
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-brand-border flex flex-col md:flex-row items-center justify-between gap-4">
