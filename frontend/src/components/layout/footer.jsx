            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex flex-wrap -mx-4 -mb-8">
                ...
                <div className="w-full xs:w-1/2 md:w-1/4 px-4 mb-8">
                  ...
                  <ul>
                    <li className="mb-6"><Link className="inline-block text-lg text-gray-500 hover:text-gray-900" to={getRouteByName('about')}>About</Link></li>
                    ...
                    <li><Link className="inline-block text-lg text-gray-500 hover:text-gray-900" to={getRouteByName('contact')}>Contact</Link></li>
                  </ul>
                </div>
                <div className="w-full xs:w-1/2 md:w-1/4 px-4 mb-8">
                  ...
                  <ul>
                    ...
                    <li className="mb-6"><Link className="inline-block text-lg text-gray-500 hover:text-gray-900" to={getRouteByName('blog')}>Blog</Link></li>
            ...
            <div className="mt-32 pt-12 border-t border-gray-200">
              <div className="flex flex-wrap items-center -mx-4">
                <div className="w-full lg:w-1/3 px-4">
                  <img src="/images/brand.svg" alt="Frequencii logo" />
                </div>
                <div className="w-full lg:w-1/3 px-4">
                  <p className="text-gray-500">Made by <a href="https://www.pixelrocket.store">Pixel Rocket</a>. All rights reserved.</p>
                </div>
                <div className="w-full lg:w-1/3 px-4">
